...
def run_net(data, params):
    ...
    if params['affinity'] == 'siamese':
        siamese_net = networks.SiameseNet(inputs, params['arch']['siamese'], params.get('siam_reg'), y_true)
        ...
        tst_siamese = siamese_net.predict(x, batch_sizes)
    else:
        siamese_net = None
    ...
    spectral_net = networks.SpectralNet(inputs, params['arch']['spectral'],
            params.get('spec_reg'), y_true, y_train_labeled_onehot, y, x,
